...
class AvailableDoctorsAdapter(private val commentsList : ArrayList<AvailableDoctorsDC>) : RecyclerView.Adapter<AvailableDoctorsAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(itemView: View,listener: AvailableDoctorsAdapter.onItemClickListener) : RecyclerView.ViewHolder(itemView) {
